package com.shxt.framework.utils.dictionary.dao;
...
public class DictionaryDao extends BaseDao {
	...
	public List<Dictionary> getAll(){
		...
		sql.append(" select GroupCode,GroupLabel,ItemCode,ItemLabel,ItemSequence from t_gt_Dictionary order by ItemSequence ");

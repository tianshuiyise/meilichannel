...
@Controller
@RequestMapping(value = "Order7")
public class Order_stateController extends BaseController implements ServletContextAware {
	Logger logger = LoggerFactory.getLogger(Order_stateController.class);
	private ServletContext servletContext;
	@Autowired
	private Order_stateService Order_stateService;

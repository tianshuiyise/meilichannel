...
import com.shxt.cme.modules.myOrder.service.cancelOrderService;
...
@Controller
@RequestMapping(value = "Order6")
public class cancelOrderController extends BaseController implements ServletContextAware {
	...
	public String list(Model model, Pageable pageable, ServletRequest request,
		...
		// 获取分页对象
		Page<Order> OrderList = cancelOrderService.findWithPage(pageable, subTrainingCourseInfo,user);

		model.addAttribute("OrderList", OrderList);
		model.addAttribute("searchParams", Servlets
				.encodeParameterStringWithPrefix(searchParams, "search_"));

		return "myOrder/cancelOrder";
	}
	...
	public String upload(Model model, Pageable pageable, ServletRequest request,
		...
		TrainingCourse subTrainingCourseInfo = BeanMapper.convertMap(
				TrainingCourse.class, searchParams);
		// 获取分页对象
		Page<Order> productList = cancelOrderService.findWithPage(pageable, subTrainingCourseInfo,user);

...
public class OrderDao extends BaseDao {
	...
	private class OrderRowMapper implements
		...
		public Order mapRow(ResultSet rs, int rowNum)
			...
			order.setOut_price(rs.getString("out_price"));
			order.setInto_price(rs.getString("into_price"));
			order.setUsefor(rs.getString("usefor"));
			order.setOutstyle(rs.getString("outstyle"));
			return order;
		}
	}

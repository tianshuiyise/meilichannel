...
<form action="${ctx }/courseChapter/add" id="courseChapterForm">
<!-- 列表区 -->
<table id="table1">
	<tr id="tr1">
	...
	<tr>
		<td id="right" width="200px;"><font color="red">*</font>章标题</td>
		<td id="left"><input type="text" id="txt_chapterName"  name="chapterName" disabled="disabled" class="required" /></td>
	</tr>
	<tr>
		<td id="right"><font color="red">*</font>章编号</td>
		<td id="left"><input type="text" id="txt_chapterCode"  name="chapterCode" disabled="disabled" class="required"/></td>
	</tr>
	<tr>
		<td id="right" width="200px;"><font color="red">*</font>主要内容</td>
		<td id="left"><input type="text"  id="txt_contentDesc"  disabled="disabled" name="contentDesc" class="required" /></td>
	</tr>
	</table>
...
<div class="content" align="center">
	...
	<span class="add"><input class="btn" type="button" value="返回" id="btn_back" onclick="back('${ctx}/courseChapter','')"/></span>
	<p>
</div>
</form>

...
<!-- 列表区 -->
<form action="${ctx }/specialty/modify" id="specialtyForm">
	<input type="hidden" name="specialtyKey" value="${specialty.specialtyKey }" />
	<table id="table1">
		<tr id="tr1">
		...
		<tr>
			...
			<td id="left">
				<input type="text" id="nameCh" name="nameCh" value="${specialty.nameCh }" class="required"/>
				<input type="hidden" id="hid_nameCh" name="hid_nameCh" value="${specialty.nameCh }"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td id="left">
				<input type="text" id="specialtyID" name="specialtyID" value="${specialty.specialtyID }" class="required" />
				<input type="hidden" id="hid_specialtyID" name="hid_specialtyID" value="${specialty.specialtyID }" />
			</td>
		</tr>
	</table>
		...
		specialtyID:{
	    	...
	    	remote:{
	    		...
	    		data:{  
                      ...
                      hid_specialtyID:function(){return $("#hid_specialtyID").val();}
                }
	    	}
		}
	},

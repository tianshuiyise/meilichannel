...
<div id="container">
      <ul class="text">
       ...
       <ul class="input">
        <li> <input type="text" name="memberName" value="${memberInfo.memberName}"/></li>
        <li></li>
        <li><input type="textarea"  name="introduction" value="${memberInfo.introduction}"/>(500字以内)</li>
        <li></li>
        <li> 
        <div id="localImag"><img id="preview" src="${ctx}/static/photo/${memberInfo.imageName}"/></div>

...
<link href="${ctx}/static/default/css/table.css" rel="stylesheet"
	type="text/css" />
		...
		<div id="main">
			...
			<div id="container">
				...
				<form id="searchForm" action="" method="post">
							...
							<c:forEach items="${memberList.content}" var="memberList"
								...
								<tr>
									...
									<td class="title4" id="title" style="width: 170px;"><input
										...
										onclick="dispatchTrainingCourse('${ctx}/serviceInfo/deleteMemb','${memberList.memberId}')" />
					...
					<div id="add">
						<p>
							<a href="${ctx }/serviceInfo/inselectMeijiaMemb">添加</a>
						</p>
					</div>

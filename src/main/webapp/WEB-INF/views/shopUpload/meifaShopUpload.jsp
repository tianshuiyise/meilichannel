...
<body>
	<div id="container">
		<form action="${ctx }/shop/meifaUploadTo?userId=${user.userId}"
						...
						<div class="box">
							<div id="info_pic">
								<img src='${ctx}/static/images/meilichannel_null.jpg '
									width="300" height="300"> <input id="image_address"
									type="hidden" name="imageAddress"
									value="${ctx}/static/images/meilichannel_null.jpg ">
							</div>
						</div> 
						<input id="changeAvatar" type="button" value="上传" /> <!-- <div id="localImag">
        	<img id="preview" />
        </div>

	...
	<div id="main">
    	...
    	<div id="container">
			...
			<c:import url="/WEB-INF/include/message.jsp"></c:import>
				<form action="${ctx }/uploadShopInfo/meirongUploadTo?userId=${user.userId}" enctype="multipart/form-data" method="post">
			<div id="container">
				<ul class="text">
					<li>*店铺名称：</li>
					<li></li>
        			...
        			<li>
						<div class="box">
				        	<div id="info_pic">
				        		...
				        		<input type="hidden" name="imageAddress" value="${ctx}/static/images/meilichannel_null.jpg " />
				        	</div>
	        			</div> 

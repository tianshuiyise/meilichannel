...
<div class="left-menu">
	...
	<div id="line1"></div>
	 ...
	 <c:if test="${empty navs}">
		...
		<ul >
			...
			<li id="xshd" class="li-list"><a href="${ctx}/toCheckAcademic/checkList" target="mainFrame">待审批学术活动</a></li>
	...
	<div class="nav">
		<ul >
			...
			<li class="li-list"><a href="${ctx}/toCheckTraining/checkList" target="mainFrame">待审批培训班</a></li>

...
<form id="searchForm"  action="${ctx}/uploadProductInfo/proInfoModify" method="POST" enctype="multipart/form-data">
<div id="workinfor">
      <div class="workin"><span><i>*</i>作品名称：</span><input type="text" name="proName" value="${productInfo.proName}"/></div>
      <div class="workin"><span><i>*</i>作品价格：</span><input type="text" name="proPrice" value="${productInfo.proPrice}"></div>
      <div class="workin"><span><i>*</i>作品优惠价格：</span><input type="text" name="disPrice" value="${productInfo.disPrice}"></div>
      <div class="workin"><span><i>*</i>作品简介：<br/><h4>(500字以内)</h4></span><input type="text"  name="introduction" value="${productInfo.introduction}"></div>
      ...
      <div class="workin"><input id="saveinfo" type="submit" value="保存修改"/></div>

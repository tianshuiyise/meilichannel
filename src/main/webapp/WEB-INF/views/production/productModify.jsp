...
<form id="searchForm"  action="${ctx}/product/proInfoModify" method="POST" enctype="multipart/form-data">
<div id="workinfor">
      ...
      <div class="workin"><span><i>*</i>作品简介：<br/><h4>(500字以内)</h4></span><textarea  name="introduction" value="${productInfo.introduction}"></textarea></div>

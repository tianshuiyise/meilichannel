...
<div id="container">
      <ul class="text">
       ...
       <ul class="input">
        <li> <input type="text" name="proName" value="${productInfo.proName}"/></li>
        <li></li>
        <li> <input type="text" name="proPrice" value="${productInfo.proPrice}"></li>
        <li></li>
        <li><input type="text" name="disPrice" value="${productInfo.disPrice}"></li>
        <li></li>
        <li><input type="textarea"  name="introduction" value="${productInfo.introduction}"/>(500字以内)</li>
        <li></li>
        <li> 
        <div id="localImag"><img id="preview" src="${ctx}/static/photo/${productInfo.imageName}"/></div>
        <input type=file name="doc" id="doc" onchange="javascript:setImagePreview();"></li>
        <li></li>
      </ul>
     <input type="reset"  value="重置">
     <input id="saveinfo" type="submit" value="保存修改"/>

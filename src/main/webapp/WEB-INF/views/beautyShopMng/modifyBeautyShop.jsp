...
<body>
	<div id="container">
		<form action="${ctx }/beautyShopMng/${shopType}/modify" enctype="multipart/form-data" method="post">
			...
			<div id="container">
				...
				<ul class="input">
					<li><input type="text" name="shopName" value="${shop.shopName}" /></li>
					<li><input type="text" name="shopCord" value="${shop.shopCord}" /></li>
					<li><input type="text" name="shopAdd" value="${shop.shopAdd}" /></li>
					<li><input type="text" name=shopType value="${shop.shopType}" /></li>
					<li><input type="text" name="introduction" value="${shop.introduction}" /></li>
					<li><input type="text" name="shopQq" value="${shop.shopQq}" /></li>
					<li><input type="text" name="merchontId" value="${shop.merchontId}" /></li>
					<li>
						<div class="box">
				        	<div id="info_pic">
				        		<img src='${ctx}/static/photo/${shop.imageName}'>
				        		<input type="text" name="imageAddress" value="${shop.imageAddress}" />
				        	</div>
	        			</div> 

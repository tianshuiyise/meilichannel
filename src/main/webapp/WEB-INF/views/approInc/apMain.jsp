...
<frameset rows="110, *, 30" frameborder="0" framespacing="0" id="main_content">
   <frame src="${ctx}/inc/top" name="topFrame" scrolling="no" noresize="noresize" id="topFrame" title="topFrame" /> 
	<frameset cols="170, *" frameborder="no" framespacing="0">  
		<frame src="${ctx}/nav/left2" name="leftFrame" scrolling="auto" noresize="noresize" id="leftFrame" title="leftFrame"  target="mainFrame"/>
		<frame src="${ctx}/" name="mainFrame" id="mainFrame" title="mainFrame" noresize="noresize"  />
	</frameset> 

...
<frameset rows="110, *, 30" frameborder="0" framespacing="0" id="main_content">
   <frame src="${ctx}/approInc/apJjwTop" name="topFrame" scrolling="no" noresize="noresize" id="topFrame" title="topFrame" /> 
	<frameset cols="220, *" frameborder="no" framespacing="0">  
		<frame src="${ctx}/nav/left5" name="leftFrame" scrolling="auto" noresize="noresize" id="leftFrame" title="leftFrame" />

...
<!-- 检索条件 -->
<form id="searchForm" action="${ctx }/homeworkOnlineScore">
	<div class="gly-top">
	<table id="s-table">
		<tr>
	...
	<tbody>
		<c:forEach items="${homeworkScoreList.content}" var="homeworkScore" varStatus="status">
			<tr>
				...
				<%-- <td id="title" style="width:50px;">${status.count}</td> --%>
				<td id="left">${homeworkScore.score}</td>
...
<div class="content" align="center">
	<span class="add"><input class="btn" type="button" value="导出" id="" onclick="exportToExcel('${ctx}/homeworkOnlineScore/export')"/></span>
	<p>
</div>
</form>
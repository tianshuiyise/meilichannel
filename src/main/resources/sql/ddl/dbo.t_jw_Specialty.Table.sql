USE [NankaiDB]
GO
/****** Object:  Table [dbo].[t_jw_Specialty]    Script Date: 07/19/2013 14:43:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[t_jw_Specialty]') AND type in (N'U'))
BEGIN
CREATE TABLE [t_jw_Specialty](
